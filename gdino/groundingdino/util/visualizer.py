...
class COCOVisualizer:
    ...
    def __init__(self, coco=None, tokenlizer=None, num_classes=1000, random_seed=42) -> None:
        self.coco = coco
        ...
        for class_id in range(num_classes):
            ...
            self.class_color_mapping[class_id] = color
    ...
    def addtgt(self, tgt):
        ...
        for idx, box in enumerate(tgt["boxes"].cpu()):
            class_idx = int(tgt["labels"][idx])
            if class_idx in self.class_color_mapping:
                c = self.class_color_mapping[class_idx]
            else:
                c = [0.6, 0.6, 0.6]  # Default color: Gray
            color.append(c)

            # Add the box to the polygons list
        ...
        # Add the patches with colors to the plot
